...
export default function RegisterPage({ onSuccess, onSwitchToLogin, onBack }) {
  ...
  return (
    <div style={styles.overlay}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.divider}><span style={{ background: "#fff", padding: "0 12px", position: "relative", top: -1 }}>or</span></div>

        <form onSubmit={handleSubmit}>
          <div style={styles.field}>
            <label style={styles.label}>Full name</label>
            <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" required style={styles.input} />
          </div>
          <div style={styles.field}>
          ...
          <div style={styles.field}>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min. 6 characters" required style={styles.input} />
          </div>
        ...
        <p style={styles.terms}>
          By creating an account you agree to our <span style={styles.link}>Terms of Service</span>.
        </p>
...
const styles = {
  ...
  divider: { textAlign: "center", color: "#bbb", fontSize: 13, marginBottom: "1.5rem", borderTop: "1px solid #eee", lineHeight: 0 },
  ...
  terms: { fontSize: 12, color: "#aaa", textAlign: "center", marginTop: "1rem" },
  switch: { textAlign: "center", fontSize: 14, color: "#777", marginTop: "0.75rem" },
